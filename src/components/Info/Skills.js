      ...
      {/* 1 item */}
        ...
        <Carousel>
            ...
            <div className='btnGroup1 text-center'>
              <Button onClick={snipsClick}><i class="fa-brands fa-github"></i> Github</Button>
              </div>
            </div> 
        </div>
        {/* 1 item */}
        ...
        <div className='btnGroup2 text-center'>
            <Button onClick={fitnessClick1}><i class="fa-brands fa-github"></i> Github</Button>
            <Button onClick={fitnessClick2}><i class="fa-brands fa-html5"></i> Website</Button>
            </div>
        </div>
        <Carousel>
            <Carousel.Item interval={3000}>
            ...
            <Carousel.Item interval={3000}>
              ...
              />
                    ...
                    <Button onClick={hcxClick1}><i class="fa-brands fa-html5"></i> tito</Button>
                    <Button onClick={hcxClick2}><i class="fa-brands fa-html5"></i> tita</Button>
                    <Button onClick={hcxClick3}><i class="fa-brands fa-html5"></i> dev</Button>
                    </div>
                    </div>
                </div>
              </div>
